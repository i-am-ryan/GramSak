    ...
    <section id="about" className="py-20 bg-background">
      <div className="container mx-auto px-4">
        ...
        <div className="mb-16 animate-slide-in-left">
          <div className="bg-gramsak-green py-16 px-8 rounded-2xl text-center shadow-lg">
            <blockquote className="text-white text-2xl md:text-4xl font-serif italic max-w-4xl mx-auto">
